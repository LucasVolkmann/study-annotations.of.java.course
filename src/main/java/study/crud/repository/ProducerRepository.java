...
import study.crud.conn.ConnectionFactory;
...
public class ProducerRepository {
    ...
    public static void delete(int id) {
        try (Connection conn = study.jdbc.conn.ConnectionFactory.getConnection();
             PreparedStatement ps = createPrepareStatementDelete(conn, id)) {
            ps.execute();
            log.info("Deleted producer (where id = '{}') from the database.", id);
        } catch (SQLException e) {
